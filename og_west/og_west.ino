...
"RO_OG_KN", "RO_OG_KS"};       //addresse
const String r_on_off[]={       
"RO_OG_KN_ON", "RO_OG_KS_ON"};         //l state
const String r_up_down[]={      
"RO_OG_KN_DO", "RO_OG_KS_DO"};         //l state
const int up_time_r[]={            
...
"DF_OG_KN", "DF_OG_KS", "DF_OG_GA", "VD_OG_KS", "VD_OG_KN"};       //addresse
const String s_up[]={           
"DF_OG_KN_UP", "DF_OG_KS_UP", "DF_OG_GA_UP", "VD_OG_KS_UP", "VD_OG_KN_UP"};         //l state
const String s_down[]={         
"DF_OG_KN_DO", "DF_OG_KS_DO", "DF_OG_GA_DO", "VD_OG_KS_DO", "VD_OG_KN_DO"};         //l state
const int up_time_s[]={         
500, 500, 500, 500, 500};       // zeit zum öffnen in ms
const int down_time_s[]={       
500, 500, 500, 500, 500};       // zeit zum schließen in ms
int value_s[]={                  
...
const unsigned long u_interval= 
